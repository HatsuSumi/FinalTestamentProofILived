...
export class TestamentSection implements Component {
  ...
  render(): HTMLElement {
    ...
    const contents: TestamentParagraph[] = [
      ...
      { text: '抑郁也是如此。它并不是某一天突然降临的灾难，而是随着时间一点点渗透进来的东西。一开始只是疲惫，后来变成迟钝，再后来，连悲伤本身都失去了清晰的轮廓。对不幸的事、痛苦的事，我逐渐变得麻木。情感、表情、语言，都慢慢失去了反应。<mark>最后只剩下一种"无心、无口、无情"的状态。</mark>' },
      ...
      { text: '<mark>半夜的时候，我经常会难受得哭泣。明知道这些发泄的声音不会被任何人听见，也不会带来任何改变，可我还是说了出来。</mark>也许正因为没人回应，我的人生一直没发生变化，也没有任何所谓的救赎。' },
      ...
      { text: '没有奇迹发生的每一天，就是我所承受的一切。我只是凭借着相对还算强的心理承受能力，接受了这一切，并继续活下去。<mark>没有奖励，也没有安慰，只是不断重复，精神状态日渐削弱。</mark>' },
