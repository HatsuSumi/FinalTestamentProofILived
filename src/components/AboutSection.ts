...
export class AboutSection implements Component {
  ...
  render(): HTMLElement {
    ...
    const paragraphs = [
      ...
      '<span class="highlight-emotion">外行人</span>可能会问，独立游戏开发<span class="highlight-core">一人身兼多职</span>把游戏做出来，有可能吗？<span class="highlight-status">我也不知道</span>，但现实<span class="highlight-status">确实存在</span>成功案例，这也是我<span class="highlight-core">不躺平的原因</span>，当然，<span class="highlight-emotion">不懂行的人</span><span class="highlight-emotion">永远不会相信</span>。',
