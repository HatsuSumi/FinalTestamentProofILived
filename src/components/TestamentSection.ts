...
export class TestamentSection implements Component {
  ...
  render(): HTMLElement {
    ...
    const contents: TestamentParagraph[] = [
      ...
      { text: '学了这么多技能，到头来只是证明了一件事：<mark>一个人永远比不过一支团队。</mark>跨领域、全栈开发，听起来很全能，<mark>实际上每个领域都只是浅尝。什么都会一点，和什么都不精通，本质上没有区别。那些改变了世界的产品，背后都是一支团队，而不是一个人。</mark>我连团队都进不去，更别说改变世界了。<mark>独立开发是有能力上限的，一个人能做出接近团队规模的项目，就已经触碰到瓶颈了。</mark>' },
