...
export class TestamentSection implements Component {
  ...
  render(): HTMLElement {
    ...
    const contents: TestamentParagraph[] = [
      ...
      { text: '自己开发的项目几乎没收到什么赞助的原因我其实也是知道的，但这<mark>并不能说明项目不够格，不够好，仅仅是因为没被人看见而已，宣传的时候就出问题了，有些人会说这是世界的法则，这个世界穷人比富人多，大家也没钱赞助，还有人会这么想"陌生人为什么要管另一个陌生人的死活呢？"，也有人会这么想"我开发的所有项目没有解决自己的痛点或者开发了跟自己所在领域无关的项目，我用不上，没有赞助的必要"。</mark>这些想法我其实都是知道的哦，所以我才讨厌这个世界[*]呀。' },
