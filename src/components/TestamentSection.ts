...
export class TestamentSection implements Component {
  ...
  render(): HTMLElement {
    ...
    const contents: TestamentParagraph[] = [
      ...
      { text: '我也几乎没有去接单、接稿，更没有尝试过送外卖、跑腿或其他需要频繁与人沟通的事情。并不是觉得那些工作有什么问题，只是我很清楚，自己无法在那样的环境中坚持下去。' },
      { text: '于是我选择了独自一人进行独立开发。一个人写代码，一个人构思，一个人解决问题。确实，这种生活方式很自由，不需要迎合他人，也不需要解释自己。<mark>但自由的另一面，是没有稳定的收入，是长期的不确定性，也是在看不到回报的情况下，不断消耗自己的时间、精力和生命。</mark>' },
      { text: '学了这么多技能，到头来只是证明了一件事：<mark>一个人永远比不过一支团队。</mark>跨领域、全栈开发，听起来很全能，<mark>实际上每个领域都只是浅尝。什么都会一点，和什么都不精通，本质上没有区别。那些改变了世界的产品，背后都是一支团队，而不是一个人。</mark>我连团队都进不去，更别说改变世界了。<mark>独立开发是有能力上限的，一个人能做出接近团队规模的项目，就已经触碰到瓶颈了。</mark>有人觉得，独立开发者只要开发周期比团队更长，就能做出同等规模的项目。但这个逻辑忽略了一件事：<mark>人不是机器。动力、执行力、成本、精力、精神状态、抑郁是否加重，还有孤独——这些变量中任何一个崩了，开发就会停摆。团队可以互相托底，一个人没有。</mark>' },
      { text: '我很清楚，只靠他人的自愿赞助来继续活下去，本身就是一条几乎无法成立的路线。<mark>这个名为‘人生’的游戏，从一开始就没有为我准备通关方式。我只是拖延着失败的结算时间而已。</mark>这很正常。'},
      { text: '我从后台可以看到，我曾经发布过的所有项目及视频的浏览量及播放量都很低。这很正常。毕竟我说过的，我不被期待。<mark>即便想造轮子、开发一个新项目，搜索引擎也告诉我市面上已有很多同类作品。自己犹豫要不要动手，就算最终开发完了，独立开发者的知名度也远不及团队，结果项目没人用，自己亏本，透支生命。</mark>这一切，依旧很正常。' },
      { text: '宣传自己辛辛苦苦开发完的项目，浏览量及播放量都很低的原因我其实是知道的，首先是<mark>宣传就有被当成广告的风险，自己辛辛苦苦开发完的项目，却被当成广告，想想都气。</mark>' },
      { text: '其次是<mark>宣传的数量问题，如果同一个项目只宣传一次，如果一次没火，那么会因为流量的原因导致没多少人看见，最终导致项目使用人数少，用户反馈少，慢慢地选择停更，甚至删库。如果同一个项目宣传多次，反复宣传，一般很多平台不允许这么做，其次是关注我的人一直反复在看我宣传同一个项目也不太好。</mark>' },
      { text: '自己开发的项目几乎没收到什么赞助的原因我其实也是知道的，但这<mark>并不能说明项目不够格，不够好，仅仅是因为没被人看见而已，宣传的时候就出问题了，有些人会说这是世界的法则，这个世界穷人比富人多，大家也没钱赞助，还有人会这么想"陌生人为什么要管另一个陌生人的死活呢？"，也有人会这么想"我开发的所有项目没有解决自己的痛点或者开发了跟自己所在领域无关的项目，我用不上，没有赞助的必要"。</mark>这些想法我其实都是知道的哦，错的是这个世界[*]。' },
      { text: '当然，我开启了<mark>零沟通接单聚道</mark>，你只需要将你遇到的痛点，或者你想别人开发的项目想法发送到我的邮箱hatsusumi-moe@163.com，在发送前建议先到搜索引擎搜索是否有类似的别人已经做好的产品，我可不想造轮子，除非指名必须是我开发的，别人开发的我都不要，<mark>我会以免费开源的形式开发出来</mark>，因为时间精力成本以及抑郁症随时会加重的原因，不保证一定会开发。' },
      { text: '如果你认为可以免费使用别人的劳动成果有罪恶感，那你可以赞助（完全自愿）。<mark>如果邮箱还是一条消息都没收到，那说明我的存在感被世界抹除了，没收到任何消息比收到消息但没开发还要痛苦。</mark>' },
      { text: '有时候我也会怀疑，这到底算不算是在"活着"。可即便如此，我还是无法说服自己去选择另一条路。<mark>至少在这里，我不需要假装成别的样子。</mark>' },
      { text: '至于爱情，那更像是一个只存在于叙事中的词语。<mark>我理解它的意义，也明白它为什么重要，却始终无法在现实中与它产生交集。</mark>它就像一条永远不会被触发的分支路线，明明写在设定里，却注定无法进入。' },
      { text: '曾经我以为，只要看到别人幸福，自己也会随之幸福。<mark>然而事实彻底否定了这一点。我不能再欺骗自己，我就是不幸福。</mark>' },
      { text: '我是独生子，没有兄弟姐妹。从出生开始，就已经习惯了"只有自己"的生活方式。<mark>到现在为止，我已经积累了好几十年的孤独经验与多年的抑郁经验。</mark>这种孤独并不激烈，也不张扬，<mark>它只是静静地存在着，像空气一样，让人几乎察觉不到，却无法摆脱。</mark>' },
      { text: '抑郁也是如此。<mark>它并不是某一天突然降临的灾难，而是随着时间一点点渗透进来的东西。一开始只是疲惫，后来变成迟钝，再后来，连悲伤本身都失去了清晰的轮廓。</mark>对不幸的事、痛苦的事，我逐渐变得麻木。情感、表情、语言，都慢慢失去了反应。<mark>最后只剩下一种"无心、无口、无情"的状态。</mark>' },
      { text: '我带着这些<mark>debuff，完全感受不到亲情、友情与爱情，不懂爱，也没被爱过，伴随着长期的孤独、抑郁以及5个不被XX[*]，再加上项目几乎没人赞助、项目内联系方式几乎没人反馈、宣传项目时还会被当成广告，就这样浑浑噩噩地活到了现在。</mark>不是因为有什么明确的目标，只是因为还没有倒下而已。' },
      { text: '<mark>半夜的时候，我经常会难受得哭泣。明知道这些发泄的声音不会被任何人听见，也不会带来任何改变，可我还是说了出来。也许正因为没人回应，我的人生一直没发生变化，也没有任何所谓的救赎。</mark>' },
      { text: '欸，我前几个页面所写的所有文案，估计不懂行以及没有经历过我事迹的人是<mark>无法理解的吧。</mark>自己被否认非常容易，只要对方不懂行，不理解自己就行了，哪怕自己曾努力过，<mark>世界这样下去就好了吗？</mark>[*]' },
      ...
      { text: '相比二次元，<mark>三次元不存在不在意对方身高、体重、外貌、性格、人品、名誉、种族、社会地位、是否有钱、是否有车、是否有房、是否有稳定工作、是否有前途、原生家庭是否正常的爱情。纯爱在三次元已经灭绝了。</mark>我随时都在做好能承受孤独终老的心理准备<mark>（其实压根活不到老）</mark>。' },
      { text: '<mark>现实，始终保持着它一贯的冷静与无趣。</mark>' },
      { text: '没有奇迹发生的每一天，就是我所承受的一切。<mark>我只是凭借着相对还算强的心理承受能力，接受了这一切，并继续活下去。</mark><mark>没有奖励，也没有安慰，只是不断重复，精神状态日渐削弱。</mark>' },
      { text: '死亡这种东西，通常是无法预测的。可我总觉得，每个人似乎都能为了"重要之物"而牺牲自己的性命。那样的选择看起来很耀眼，也很有重量。但我活到现在，却始终没有遇到过那样的存在。<mark>没有重要之物，没有不能忘记的人，没有绝对要守护的事物[*]。</mark>这很正常。毕竟我说过的，我不被认可和信任。' },
      ...
      { text: '我无法衡量生命的重量。因为在我的人生里，从未有过可以用来对比的参照。<mark>我只是做着自己想做的事情，随心所欲地活到了现在[*]。</mark>而本站，就是我活过的证明。' },
      { text: '我很清楚，唯有持续开发创作，才能让更多人认识我，让本站变得有意义。<mark>如果连活过的证明都不被人看到，那我从出生到死亡都是完全不为人所知的。</mark>这不是我想要的未来。' },
      { text: '当然，<mark>没看到的人就是没看到。不知道我活过，不知道我写的遗书，不知道我的作品，就连这段文字也看不到。</mark>' },
      { text: '如果所谓的自我救赎真的能够成功，那为什么会出现相互救赎呢？也许我的核心问题，并不是我不够努力，而是<mark>从一开始，就出生在了错误的世界观里。</mark>' },
      { text: '我了解过救赎学，<mark>自我救赎很难，被他人救赎更难</mark>，对方需要了解你并尝试救赎你，<mark>走错一步都容易导致Bad End，还要尽量避免无效救赎。</mark>' },
      { text: '有时我会思考，没钱的情况下是否还能继续为爱发电。但我不认为为爱发电是错误的选择，<mark>错的是这个无法容纳为爱发电的世界。</mark>' },
      { text: '我知道，二次元也并不完美。那里同样充满悲剧、失去与痛苦。但至少，那些痛苦看起来更温柔一些。<mark>二次元带给我的所有感动与刀子，我都会记住。</mark>' },
      { text: '这一切，仅此而已。<mark>この世界、だいっきらい。</mark>' },
      { text: '以上遗书内容仅为提前写的，留给未来。并不是写完就去死，人还没死。' },
      { text: '<mark>我声明：本站所有文本均为本人真实记录，不涉及虚构或刻意夸张。（中国人不骗中国人，否则我死全家）</mark>' },
      { text: '<mark>声明人：陈冠霖。</mark>' },
      { text: '致亲戚朋友：' },
      { text: '如果你发现了这个网站，不要多想，这里的陈冠霖就是你最熟悉的那个陈冠霖。至于为什么死之前不把这些话说出去——原因很简单，就拿游戏举例子吧，有个叫"好感度"的东西，好感度累积到一定数量，对方才会吐露真心话。而我作为独生子，没有兄弟姐妹，没有可以述说的对象。<mark>表兄弟姐妹是节日限定，节日一过，好感度归零，毕竟平时根本不联系，节日见一面，节日过后又各自消失，好感度没有累积的土壤，从未达到能述说的阈值。亲兄弟姐妹是日常限定。</mark>但我没有，所以这条路不是走不到——是从一开始就没有被写进我的人生。<mark>这种叫做"谈心"的剧情桥段，只存在于别人的人生里。</mark>' },
      { text: '为什么只讲了兄弟姐妹为什么不能救赎自己？别人救赎不行吗？' },
      { text: '<mark>恋人需要条件，朋友需要维系，陌生人几乎不可能。</mark>父母这条路，并不是不存在，而是<mark>从一开始就没有建立起可以通向"谈心"的连接。</mark>唯一不需要任何前提、能自然累积好感度的关系，只剩下亲兄弟姐妹。<mark>但这一项，在我的人生里，从一开始就没有被配置。</mark>' }
    ];
