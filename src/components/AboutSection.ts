...
export class AboutSection implements Component {
  ...
  render(): HTMLElement {
    ...
    const paragraphs = [
      ...
      '同时我也是一位<span class="highlight-emotion">极度内向社恐</span>的人，甚至连<span class="highlight-emotion">人类都感到害怕</span>，我<span class="highlight-emotion">非常不擅长与人沟通</span>，这也是我成为<span class="highlight-identity">独立开发者</span>的原因，我<span class="highlight-status">没想过</span>去找工作，也<span class="highlight-status">几乎没有</span>去接单，接稿，送外卖，而是自己一人在家进行独立开发。一个人，一个房间，一台电脑，<span class="highlight-status">与世隔绝</span>，<span class="highlight-emotion">寂静无声</span>，一天接一天，<span class="highlight-emotion">消耗生命</span>，<span class="highlight-emotion">可能出现尸体</span>。<span class="highlight-status">我已经放弃了合作的可能</span>。',
      '如果说<span class="highlight-status">完全不与人沟通活下去</span>是<span class="highlight-status">不现实</span>的，那么就<span class="highlight-emotion">不活了</span>，<span class="highlight-emotion">死亡后会轻松很多</span>，不用考虑任何事情，<span class="highlight-core">真正内向社恐等的人是不会喊救命的</span>。',
      '因此我的大多数作品的开发/制作环境都是<span class="highlight-status">居家开发</span>，<span class="highlight-status">没有工作，没有收入</span>，在<span class="highlight-emotion">抑郁症和孤独</span>的陪伴下。因为项目<span class="highlight-core">开源免费</span>，所以本身<span class="highlight-status">并不赚钱</span>，也<span class="highlight-status">没有</span>回本，甚至<span class="highlight-emotion">透支</span>生命。可以发现我的项目大多数都部署在Github或者Netlify这种免费部署平台上，原因很简单，对于<span class="highlight-status">月入0元</span>的我来说，<span class="highlight-status">最便宜的服务器都租不起</span>。<span class="highlight-status">如果哪天我的项目用上了服务器</span>，那一定是<span class="highlight-emotion">父母的钱</span>。',
      '为什么明明<span class="highlight-status">没有收入</span>，却还在做这些<span class="highlight-core">免费开源</span>的项目？我也不知道，可能因为我是个<span class="highlight-emotion">傻逼</span>吧，不对，花了<span class="highlight-status">数月</span><span class="highlight-status">好几千成本</span>开发完的项目却<span class="highlight-core">免费开源</span>，我就是个<span class="highlight-emotion">傻逼</span>。我只知道<span class="highlight-core">免费一辈子都不会改变</span>，<span class="highlight-core">弘扬为爱发电精神</span>，<span class="highlight-core">践行为爱发电理念</span>，<span class="highlight-status">其实也不可能收费</span>，因为调用微信/支付宝提供的API<span class="highlight-status">就需要服务器了</span>，我只靠<span class="highlight-core">赞助支持</span>（<span class="highlight-core">完全自愿</span>）和<span class="highlight-emotion">啃老</span>活下去，<span class="highlight-emotion">我是有罪恶感的</span>，但<span class="highlight-status">除此之外没有别的方法</span>，<span class="highlight-status">免费的项目几乎没有人主动赞助</span>，所以<span class="highlight-status">只能</span><span class="highlight-core">为爱发电</span><span class="highlight-emotion">到死为止</span>。',
      '我要成为历史上<span class="highlight-status">第n位</span><span class="highlight-core">为爱发电到死为止</span>的人，完成这一<span class="highlight-core">壮举</span>，如果<span class="highlight-core">为爱发电到死</span>能<span class="highlight-core">被互联网铭记</span>，那我就<span class="highlight-emotion">死而无憾</span>了，我<span class="highlight-core">活着的意义</span>就只有<span class="highlight-core">为爱发电</span>了。你可能经常听到"谁不是为了赚钱而工作？"这句话，但我就是个<span class="highlight-core">反例</span>，没错，<span class="highlight-core">我对金钱不感兴趣</span>，<span class="highlight-emotion">我只对死亡感兴趣</span>。',
      ...
      '<span class="highlight-emotion">外行人</span>可能会问，独立游戏开发<span class="highlight-core">一人身兼多职</span>把游戏做出来，有可能吗？<span class="highlight-status">我也不知道</span>，但现实<span class="highlight-status">确实存在</span>成功案例，这也是我<span class="highlight-core">不躺平的原因</span>，当然，<span class="highlight-emotion">不懂行的人</span><span class="highlight-emotion">永远不会相信明白理解</span>。',
