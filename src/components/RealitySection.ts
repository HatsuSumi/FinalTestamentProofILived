...
export class RealitySection implements Component {
  ...
  render(): HTMLElement {
    ...
    // 现实列表
    const realities = [
      '项目内留下的联系方式形同虚设，所有bug都是开发者自己发现的，从未收到过用户反馈，从项目上线就一直在演独角戏，用户不反馈开发者都不知道如何改进，欸。',
      '项目内的赞助入口形同虚设，除非强制收费，否则没人会主动付费。',
      '大多数项目发布时心里想着等有用户赞助支持的时候再持续更新，但现实告诉我几乎没人赞助，所以很多项目死得快，开发者连持续更新的动力都没收到。',
      '大多数用户只知道"开发者做了个什么样的项目"，但不知道"开发者的开发环境和精神状态"。',
      '辛辛苦苦开发完的项目，推广宣传的时候，却还有被当成广告的风险。',
      ...
      '别人花相同的时间精力精通单一领域，而我花相同的时间精力熟悉各个领域，所以在单一领域上我是永远比不过别人的，给我带来的自卑是无法避免的，别对我抱有太大的期待，我只是个废物而已，但我不后悔选择独立游戏开发这条路。',
      '一人根本无法长期运营维护项目，我很多项目停更就是因为精力耗尽，网站的举报功能、内容审核都只是装饰，从来没有时间和精力去处理。',
      '未来就算做出前后端俱全的大型项目，当服务器被攻击的那一天，也会因为一人应付不过来而被迫废弃。',
      '留给后来者：没事尽量别从事独立游戏开发者这个职业，尤其是想一人开发出中大型游戏的，真的会死人的。（虽然听说独立动画死的更快？）'
    ];
