...
export class AboutSection implements Component {
  ...
  render(): HTMLElement {
    ...
    const paragraphs = [
      ...
      '为什么明明<span class="highlight-status">没有收入</span>，却还在做这些<span class="highlight-core">免费开源</span>的项目？我也不知道，可能是因为我是个<span class="highlight-emotion">傻逼</span>吧，<mark>不对，花了数月好几千成本开发完的项目却免费开源，我就是个傻逼。</mark>我只知道<span class="highlight-core">免费一辈子都不会改变</span>，<span class="highlight-status">其实也不可能收费</span>，因为调用微信/支付宝提供的API<span class="highlight-status">就需要服务器了</span>，我只靠<span class="highlight-core">赞助支持</span>（<span class="highlight-core">完全自愿</span>）和<span class="highlight-emotion">啃老</span>活下去，<span class="highlight-emotion">我是有罪恶感的</span>，但<span class="highlight-status">除此之外没有别的方法</span>，<span class="highlight-status">免费的项目几乎没有人主动赞助</span>，所以<span class="highlight-status">只能</span><span class="highlight-core">为爱发电</span><span class="highlight-emotion">到死为止</span>。你可能经常听到"谁不是为了赚钱而工作？"这句话，但我就是个<span class="highlight-core">反例</span>，没错，<span class="highlight-core">我对金钱不感兴趣</span>，<span class="highlight-emotion">我只对死亡感兴趣</span>。',
