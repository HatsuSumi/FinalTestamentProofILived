...
export class TestamentSection implements Component {
  ...
  render(): HTMLElement {
    ...
    const contents: TestamentParagraph[] = [
      ...
      { text: '宣传自己辛辛苦苦开发完的项目，浏览量及播放量都很低的原因我其实是知道的，首先是宣传就有被当成广告的风险，自己辛辛苦苦开发完的项目，却被当成广告，想想都气。' },
      { text: '其次是宣传的数量问题，如果同一个项目只宣传一次，如果一次没火，那么会因为流量的原因导致没多少人看见，最终导致项目使用人数少，用户反馈少，慢慢地选择停更，甚至删库。如果同一个项目宣传多次，反复宣传，一般很多平台不允许这么做，其次是关注我的人一直反复在看我宣传同一个项目也不太好。' },
      { text: '自己开发的项目几乎没收到什么赞助的原因我其实也是知道的，但这并不能说明项目不够格，不够好，仅仅是因为没被人看见而已，宣传的时候就出问题了，有些人会说这是世界的法则，这个世界穷人比富人多，大家也没钱赞助，还有人会这么想"陌生人为什么要管另一个陌生人的死活呢？"，也有人会这么想"我开发的所有项目没有解决自己的痛点或者开发了跟自己所在领域无关的项目，我用不上，没有赞助的必要"。这些想法我其实都是知道的哦，所以我才讨厌这个世界[*]呀。' },
      ...
      { text: '我是独生子，没有兄弟姐妹。从出生开始，就已经习惯了"只有自己"的生活方式。到现在为止，我已经积累了好几十年的孤独经验与多年的抑郁经验。这种孤独并不激烈，也不张扬，它只是静静地存在着，像空气一样，让人几乎察觉不到，却无法摆脱。' },
      ...
      { text: '我带着这些debuff，完全感受不到亲情、友情与爱情，不懂爱，也没被爱过，伴随着长期的孤独、抑郁以及5个不被XX[*]，再加上项目几乎没人赞助、项目内联系方式几乎没人反馈、宣传项目时还会被当成广告，就这样浑浑噩噩地活到了现在。不是因为有什么明确的目标，只是因为还没有倒下而已。' },
      ...
      { text: '我很清楚，唯有持续开发创作，才能让更多人认识我，让本站变得有意义。如果连活过的证明都不被人看到，那我从出生到死亡都是完全不为人所知的。这不是我想要的未来。' },
      { text: '当然，没看到的人就是没看到。不知道我活过，不知道我写的遗书，不知道我的作品，就连这段文字也看不到。' },
      { text: '如果所谓的自我救赎真的能够成功，那为什么会出现相互救赎呢？也许我的核心问题，并不是我不够努力，而是从一开始，就出生在了错误的世界观里。' },
      { text: '有时我会思考，没钱的情况下是否还能继续为爱发电。但我不认为为爱发电是错误的选择，错的是这个无法容纳为爱发电的世界。' },
